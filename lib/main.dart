...
class OurSchoolApp extends StatelessWidget {
  ...
  Widget getHome(BuildContext context) {
    ...
    // this code is responsible for showing profile page
    //i am trying to register in the previous page... this is page after i enter email and password
    // ok understood wait
    if (Provider.of<bool>(context, listen: false)) {
      if (userType == UserType.STUDENT) {
        // this is where the page is displayed
